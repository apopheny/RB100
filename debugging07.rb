...
[january, february, march].map do |month|
  balance = calculate_balance(month) + balance
end
...
# the problem is that we are only printing the iteration for march in isolation of the other months, rather than summing them together.
