...
# 'Xyzzy'. Top level local variable a is still not available to the method for reassignment, nor is the local variable inside the method visible outside of the method.
